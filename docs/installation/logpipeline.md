...
!!! note
    ...
    script and the [atb-kyoushi-gather role](https://github.com/ait-testbed/atb-kyoushi-gather)
...
!!! note
    These settings are pre-configured in the [AttackBed](https://github.com/ait-testbed/attackbed), and the pipeline
    should work out of the box after enabling [Filebeat](#filebeat) and following the steps in the [Deployment](#deployment) section.
...
Build the images with packer, as described in the [Build server images manually](images.md#build-server-images-manually) section.
