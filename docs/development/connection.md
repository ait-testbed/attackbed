...
![Firefox connection settings configured to use the SSH SOCKS proxy on localhost port 1080.](../images/proxy.png)
...
![The ZoneMinder web interface on the videoserver, accessed through the SOCKS proxy tunnel.](../images/zoneminder.png)
