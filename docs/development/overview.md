...
1.  **Prerequisites:** Ensure you have the necessary base software installed, such as OpenStack, OpenTofu, Ansible, Terragrunt (see [Requirements](../installation/requirements.md))
